 ...
 *     void (*reposition)(struct wl_client *, struct wl_resource *, struct wl_resource *, uint32_t);
 * }
 * }
 */
public class xdg_popup_interface {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        C.C_POINTER.withName("reposition")
    ).withName("xdg_popup_interface");
    ...
    public static class grab {
        ...
        private static final MethodHandle UP$MH = C.upcallHandle(grab.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(grab.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final long grab$OFFSET = 8;
    ...
    public static class reposition {
        ...
        private static final MethodHandle UP$MH = C.upcallHandle(reposition.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(reposition.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout reposition$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("reposition"));
     ...
     * }
     */
    public static final AddressLayout reposition$layout() {
        return reposition$LAYOUT;
    }

    private static final long reposition$OFFSET = 16;
    ...
    public static MemorySegment reposition(MemorySegment struct) {
        return struct.get(reposition$LAYOUT, reposition$OFFSET);
    }
    ...
    public static void reposition(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(reposition$LAYOUT, reposition$OFFSET, fieldValue);
    }
