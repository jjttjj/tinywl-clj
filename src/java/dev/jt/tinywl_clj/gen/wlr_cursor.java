...
public class wlr_cursor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wlr_cursor.events.layout().withName("events"),
    ...
    public static class events {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            wl_signal.layout().withName("touch_up"),
            wl_signal.layout().withName("touch_down"),
            wl_signal.layout().withName("touch_motion"),
            wl_signal.layout().withName("touch_cancel"),
            wl_signal.layout().withName("touch_frame"),
            wl_signal.layout().withName("tablet_tool_axis"),
            wl_signal.layout().withName("tablet_tool_proximity"),
            wl_signal.layout().withName("tablet_tool_tip"),
            wl_signal.layout().withName("tablet_tool_button")
        ).withName("$anon$51:2");
        ...
        private static final GroupLayout touch_up$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("touch_up"));
         ...
         * }
         */
        public static final GroupLayout touch_up$layout() {
            return touch_up$LAYOUT;
        }

        private static final long touch_up$OFFSET = 208;
         ...
         * }
         */
        public static final long touch_up$offset() {
            return touch_up$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment touch_up(MemorySegment struct) {
            return struct.asSlice(touch_up$OFFSET, touch_up$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void touch_up(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, touch_up$OFFSET, touch_up$LAYOUT.byteSize());
        }

        private static final GroupLayout touch_down$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("touch_down"));
         ...
         * }
         */
        public static final GroupLayout touch_down$layout() {
            return touch_down$LAYOUT;
        }

        private static final long touch_down$OFFSET = 224;
         ...
         * }
         */
        public static final long touch_down$offset() {
            return touch_down$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment touch_down(MemorySegment struct) {
            return struct.asSlice(touch_down$OFFSET, touch_down$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void touch_down(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, touch_down$OFFSET, touch_down$LAYOUT.byteSize());
        }

        private static final GroupLayout touch_motion$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("touch_motion"));
         ...
         * }
         */
        public static final GroupLayout touch_motion$layout() {
            return touch_motion$LAYOUT;
        }

        private static final long touch_motion$OFFSET = 240;
         ...
         * }
         */
        public static final long touch_motion$offset() {
            return touch_motion$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment touch_motion(MemorySegment struct) {
            return struct.asSlice(touch_motion$OFFSET, touch_motion$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void touch_motion(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, touch_motion$OFFSET, touch_motion$LAYOUT.byteSize());
        }

        private static final GroupLayout touch_cancel$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("touch_cancel"));
         ...
         * }
         */
        public static final GroupLayout touch_cancel$layout() {
            return touch_cancel$LAYOUT;
        }

        private static final long touch_cancel$OFFSET = 256;
         ...
         * }
         */
        public static final long touch_cancel$offset() {
            return touch_cancel$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment touch_cancel(MemorySegment struct) {
            return struct.asSlice(touch_cancel$OFFSET, touch_cancel$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void touch_cancel(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, touch_cancel$OFFSET, touch_cancel$LAYOUT.byteSize());
        }

        private static final GroupLayout touch_frame$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("touch_frame"));
         ...
         * }
         */
        public static final GroupLayout touch_frame$layout() {
            return touch_frame$LAYOUT;
        }

        private static final long touch_frame$OFFSET = 272;
         ...
         * }
         */
        public static final long touch_frame$offset() {
            return touch_frame$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment touch_frame(MemorySegment struct) {
            return struct.asSlice(touch_frame$OFFSET, touch_frame$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void touch_frame(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, touch_frame$OFFSET, touch_frame$LAYOUT.byteSize());
        }

        private static final GroupLayout tablet_tool_axis$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("tablet_tool_axis"));
         ...
         * }
         */
        public static final GroupLayout tablet_tool_axis$layout() {
            return tablet_tool_axis$LAYOUT;
        }

        private static final long tablet_tool_axis$OFFSET = 288;
         ...
         * }
         */
        public static final long tablet_tool_axis$offset() {
            return tablet_tool_axis$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment tablet_tool_axis(MemorySegment struct) {
            return struct.asSlice(tablet_tool_axis$OFFSET, tablet_tool_axis$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void tablet_tool_axis(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, tablet_tool_axis$OFFSET, tablet_tool_axis$LAYOUT.byteSize());
        }

        private static final GroupLayout tablet_tool_proximity$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("tablet_tool_proximity"));
         ...
         * }
         */
        public static final GroupLayout tablet_tool_proximity$layout() {
            return tablet_tool_proximity$LAYOUT;
        }

        private static final long tablet_tool_proximity$OFFSET = 304;
         ...
         * }
         */
        public static final long tablet_tool_proximity$offset() {
            return tablet_tool_proximity$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment tablet_tool_proximity(MemorySegment struct) {
            return struct.asSlice(tablet_tool_proximity$OFFSET, tablet_tool_proximity$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void tablet_tool_proximity(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, tablet_tool_proximity$OFFSET, tablet_tool_proximity$LAYOUT.byteSize());
        }

        private static final GroupLayout tablet_tool_tip$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("tablet_tool_tip"));
         ...
         * }
         */
        public static final GroupLayout tablet_tool_tip$layout() {
            return tablet_tool_tip$LAYOUT;
        }

        private static final long tablet_tool_tip$OFFSET = 320;
         ...
         * }
         */
        public static final long tablet_tool_tip$offset() {
            return tablet_tool_tip$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment tablet_tool_tip(MemorySegment struct) {
            return struct.asSlice(tablet_tool_tip$OFFSET, tablet_tool_tip$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void tablet_tool_tip(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, tablet_tool_tip$OFFSET, tablet_tool_tip$LAYOUT.byteSize());
        }

        private static final GroupLayout tablet_tool_button$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("tablet_tool_button"));
         ...
         * }
         */
        public static final GroupLayout tablet_tool_button$layout() {
            return tablet_tool_button$LAYOUT;
        }

        private static final long tablet_tool_button$OFFSET = 336;
         ...
         * }
         */
        public static final long tablet_tool_button$offset() {
            return tablet_tool_button$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment tablet_tool_button(MemorySegment struct) {
            return struct.asSlice(tablet_tool_button$OFFSET, tablet_tool_button$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void tablet_tool_button(MemorySegment struct, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, struct, tablet_tool_button$OFFSET, tablet_tool_button$LAYOUT.byteSize());
        }
