 ...
 * }
 */
public class wl_data_device_interface {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_POINTER.withName("start_drag"),
        C.C_POINTER.withName("set_selection"),
        C.C_POINTER.withName("release")
    ).withName("wl_data_device_interface");
     ...
     * }
     */
    public static class start_drag {
        ...
        private static final MethodHandle UP$MH = C.upcallHandle(start_drag.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(start_drag.Function fi, Arena arena) {
    ...
    private static final AddressLayout start_drag$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("start_drag"));
     ...
     * }
     */
    public static final AddressLayout start_drag$layout() {
        return start_drag$LAYOUT;
    }

    private static final long start_drag$OFFSET = 0;
    ...
    public static MemorySegment start_drag(MemorySegment struct) {
        return struct.get(start_drag$LAYOUT, start_drag$OFFSET);
    }
    ...
    public static void start_drag(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(start_drag$LAYOUT, start_drag$OFFSET, fieldValue);
    }
    ...
    public static class set_selection {
        ...
        private static final MethodHandle UP$MH = C.upcallHandle(set_selection.Function.class, "apply", $DESC);
    ...
    private static final long set_selection$OFFSET = 8;
