...
public class pixman_triangle {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        pixman_point_fixed.layout().withName("p3")
    ).withName("pixman_triangle");
    ...
    private static final GroupLayout p3$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("p3"));
     ...
     * }
     */
    public static final GroupLayout p3$layout() {
        return p3$LAYOUT;
    }

    private static final long p3$OFFSET = 16;
     ...
     * }
     */
    public static final long p3$offset() {
        return p3$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment p3(MemorySegment struct) {
        return struct.asSlice(p3$OFFSET, p3$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void p3(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, p3$OFFSET, p3$LAYOUT.byteSize());
    }
