...
public class pixman_box32 {
    ...
    private static final long y1$OFFSET = 4;
    ...
    private static final OfInt x2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("x2"));
     ...
     * }
     */
    public static final OfInt x2$layout() {
        return x2$LAYOUT;
    }

    private static final long x2$OFFSET = 8;
     ...
     * }
     */
    public static int x2(MemorySegment struct) {
     ...
     * }
     */
    public static void x2(MemorySegment struct, int fieldValue) {
        struct.set(x2$LAYOUT, x2$OFFSET, fieldValue);
    }

    private static final OfInt y2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("y2"));
     ...
     * }
     */
    public static final OfInt y2$layout() {
        return y2$LAYOUT;
    }

    private static final long y2$OFFSET = 12;
     ...
     * }
     */
    public static int y2(MemorySegment struct) {
     ...
     * }
     */
    public static void y2(MemorySegment struct, int fieldValue) {
