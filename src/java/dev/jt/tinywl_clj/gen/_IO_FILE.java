...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        C.C_POINTER.withName("_IO_read_ptr"),
        C.C_POINTER.withName("_IO_read_end"),
        C.C_POINTER.withName("_IO_read_base"),
        C.C_POINTER.withName("_IO_write_base"),
        C.C_POINTER.withName("_IO_write_ptr"),
        C.C_POINTER.withName("_IO_write_end"),
        C.C_POINTER.withName("_IO_buf_base"),
        C.C_POINTER.withName("_IO_buf_end"),
        C.C_POINTER.withName("_IO_save_base"),
        C.C_POINTER.withName("_IO_backup_base"),
        C.C_POINTER.withName("_IO_save_end"),
        C.C_POINTER.withName("_markers"),
        C.C_POINTER.withName("_chain"),
        C.C_INT.withName("_fileno"),
        C.C_INT.withName("_flags2"),
        C.C_LONG.withName("_old_offset"),
        C.C_SHORT.withName("_cur_column"),
        C.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, C.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        C.C_POINTER.withName("_lock"),
        C.C_LONG.withName("_offset"),
        C.C_POINTER.withName("_codecvt"),
        C.C_POINTER.withName("_wide_data"),
        C.C_POINTER.withName("_freeres_list"),
        C.C_POINTER.withName("_freeres_buf"),
        C.C_LONG.withName("__pad5"),
        C.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, C.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
