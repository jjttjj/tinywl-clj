...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_INT.withName("tm_sec"),
        C.C_INT.withName("tm_min"),
        C.C_INT.withName("tm_hour"),
        C.C_INT.withName("tm_mday"),
        C.C_INT.withName("tm_mon"),
        C.C_INT.withName("tm_year"),
        C.C_INT.withName("tm_wday"),
        C.C_INT.withName("tm_yday"),
        C.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        C.C_LONG.withName("tm_gmtoff"),
        C.C_POINTER.withName("tm_zone")
    ).withName("tm");
