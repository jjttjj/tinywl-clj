...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_INT.withName("__readers"),
        C.C_INT.withName("__writers"),
        C.C_INT.withName("__wrphase_futex"),
        C.C_INT.withName("__writers_futex"),
        C.C_INT.withName("__pad3"),
        C.C_INT.withName("__pad4"),
        C.C_INT.withName("__cur_writer"),
        C.C_INT.withName("__shared"),
        C.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, C.C_CHAR).withName("__pad1"),
        C.C_LONG.withName("__pad2"),
        C.C_INT.withName("__flags"),
