...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_LONG.withName("st_dev"),
        C.C_LONG.withName("st_ino"),
        C.C_LONG.withName("st_nlink"),
        C.C_INT.withName("st_mode"),
        C.C_INT.withName("st_uid"),
        C.C_INT.withName("st_gid"),
        C.C_INT.withName("__pad0"),
        C.C_LONG.withName("st_rdev"),
        C.C_LONG.withName("st_size"),
        C.C_LONG.withName("st_blksize"),
        C.C_LONG.withName("st_blocks"),
        timespec.layout().withName("st_atim"),
        timespec.layout().withName("st_mtim"),
        timespec.layout().withName("st_ctim"),
        MemoryLayout.sequenceLayout(3, C.C_LONG).withName("__glibc_reserved")
    ).withName("stat");
