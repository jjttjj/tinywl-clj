...
public class pixman_color {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_SHORT.withName("red"),
        C.C_SHORT.withName("green"),
        C.C_SHORT.withName("blue"),
        C.C_SHORT.withName("alpha")
    ).withName("pixman_color");
    ...
    private static final long alpha$OFFSET = 6;
