...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_INT.withName("__lock"),
        C.C_INT.withName("__count"),
        C.C_INT.withName("__owner"),
        C.C_INT.withName("__nusers"),
        C.C_INT.withName("__kind"),
        C.C_SHORT.withName("__spins"),
        C.C_SHORT.withName("__elision"),
