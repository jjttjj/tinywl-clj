 ...
 * }
 */
public class wlr_scene_outputs_update_event {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        C.C_POINTER.withName("active"),
        C.C_LONG.withName("size")
    ).withName("wlr_scene_outputs_update_event");
    ...
    private static final AddressLayout active$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("active"));
     ...
     * }
     */
    public static final AddressLayout active$layout() {
